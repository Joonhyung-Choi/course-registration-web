    ...
    return (
      ...
      <div
        style={{
          position: `absolute`,
          left: `${
            props.xPosition / 2 + 30 + checkDay(element.courseTime) * 10
          }vw`,
          top: `${1.6 + 3 * checkTime(element.courseTime)[0]}vw`,
          width: `10vw`,
          height: `${3 * checkTime(element.courseTime).length}vw`,
          border: `1px solid orange`,
          backgroundColor: `#fffdad`,
